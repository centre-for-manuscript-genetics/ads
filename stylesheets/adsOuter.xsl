...
<a><!-- STATIC CONVERSION 2026-03-10: new url mapping --><xsl:attribute name="href">javascript:MM_openBrWindow('<xsl:value-of select="$document"/>.xml','','width=825,height=538,resizable=yes,scrollbars=yes')</xsl:attribute>XML Bronbestand</a>
</div>
...
<p class="navigation"><form method="POST" name="test" style="display: inline"><!-- STATIC CONVERSION 2026-03-10: new url mapping --><script language="javascript">
function warp(){

...
<xsl:choose>
 ...
 <table align="center" width="100%">
  <tr>
   ...
   <td width="1%"/><td align="left" width="49%"><p class="navigation"><xsl:if test="$documentn = '24'"><img border="0" src="images/navi/right.jpg"/></xsl:if><xsl:if test="$documentn != '24'"><a><xsl:attribute name="href"><xsl:if test="starts-with(document('../../ads/xml/toc.xml')//toc/document[@n=$documentn + 1]/@id,'Ads')">Ads.htm</xsl:if><xsl:if test="starts-with(document('../../ads/xml/toc.xml')//toc/document[@n=$documentn + 1]/@id,'Opd')">Opd.htm</xsl:if>?text=docfacs&amp;document=<xsl:value-of select="document('../../ads/xml/toc.xml')//toc/document[@n=$documentn + 1]/@id"/>&amp;page=<xsl:value-of select="document('../../ads/xml/toc.xml')//toc/document[@id=$document]/thumbs/page[@id=$page]/@next"/></xsl:attribute><img border="0" src="images/navi/right.jpg"/><xsl:text> </xsl:text><xsl:value-of select="document('../../ads/xml/toc.xml')//toc/document[@n=$documentn + 1]/@short"/></a></xsl:if></p></td></tr>
     <!-- onder -->
   <tr><td align="center" colspan="3"><p class="navigation"><xsl:if test="$pagelast"><img border="0" src="images/navi/down.jpg"/></xsl:if><xsl:if test="not($pagelast)"><a><xsl:attribute name="href"><xsl:value-of select="substring($document,1,3)"/>.htm?text=<xsl:if test="$text='docfacspop'">docfacs</xsl:if><xsl:if test="$text!='docfacspop'"><xsl:value-of select="$text"/></xsl:if>&amp;document=<xsl:value-of select="$document"/>&amp;page=<xsl:value-of select="document('../../ads/xml/toc.xml')//toc/document[@id=$document]/thumbs/page[@n=$pageid + 1]/@id"/></xsl:attribute><img src="images/navi/down.jpg" border="0"/><br/><xsl:if test="not(contains(document('../../ads/xml/toc.xml')//toc/document[@id=$document]/thumbs/page[@n=$pageid + 1]/@id,'a'))">p. </xsl:if><xsl:value-of select="document('../../ads/xml/toc.xml')//toc/document[@id=$document]/thumbs/page[@n=$pageid + 1]/@id"/></a></xsl:if></p></td></tr>
  </table>
 </div>
 </xsl:if>
 ...
 <xsl:if test="$text='docfacstopo'"><img src="images/navi/dot.jpg"/><xsl:text> </xsl:text><a><xsl:attribute name="href"><xsl:value-of select="substring($document,1,3)"/>.htm?text=docfacs&amp;document=<xsl:value-of select="$document"/>&amp;page=<xsl:value-of select="$page"/></xsl:attribute>Facsimile</a><br/></xsl:if>
 <xsl:if test="$document='AdsM1' and $text='docfacs' or $text='docfacspop'"><img src="images/navi/dot.jpg"/><xsl:text> </xsl:text><a><xsl:attribute name="href"><xsl:value-of select="substring($document,1,3)"/>.htm?text=docfacstopo&amp;document=<xsl:value-of select="$document"/>&amp;page=<xsl:value-of select="$page"/></xsl:attribute>Topografische transcriptie</a><br/></xsl:if>
 <xsl:if test="$document='AdsM1' and $text='docfacs' or $text='docfacstopo'"><img src="images/navi/dot.jpg"/><xsl:text> </xsl:text><a><xsl:attribute name="href"><xsl:value-of select="substring($document,1,3)"/>.htm?text=docfacspop&amp;document=<xsl:value-of select="$document"/>&amp;page=<xsl:value-of select="$page"/></xsl:attribute>Facsimile + Topografisch</a><br/></xsl:if>
 <xsl:if test="$document='AdsM1'"><img src="images/navi/dot.jpg"/><xsl:text> </xsl:text><a><xsl:attribute name="href"><xsl:value-of select="substring($document,1,3)"/>.htm?text=docfacszoom&amp;document=<xsl:value-of select="$document"/>&amp;page=<xsl:value-of select="$page"/></xsl:attribute>Vergrootglas facsimile</a><br/></xsl:if>
...
<td><p><center><a><xsl:attribute name="href"><xsl:value-of select="substring($document,1,3)"/>.htm?text=<xsl:if test="$text='docfacspop'">docfacs</xsl:if><xsl:if test="$text!='docfacspop'"><xsl:value-of select="$text"/></xsl:if>&amp;document=<xsl:value-of select="$document"/>&amp;page=<xsl:value-of select="@id"/></xsl:attribute><img border="0" width="100"><xsl:attribute name="src">images/<xsl:value-of select="$document"/>/thumbs/<xsl:value-of select="$document"/>-<xsl:value-of select="@id"/>.jpg</xsl:attribute></img><br/><xsl:value-of select="@id"/></a></center></p></td>
</xsl:for-each></tr>
...
<xsl:choose>
 ...
 <xsl:if test="$text='doclinlay'"><a><xsl:attribute name="name"><xsl:value-of select="@n"/></xsl:attribute></a><a><xsl:attribute name="name"><xsl:value-of select="@base"/></xsl:attribute></a><a><xsl:if test="$export='print'"><xsl:attribute name="onclick">return false</xsl:attribute></xsl:if><xsl:attribute name="href">zin.htm?text=doclinlay&amp;document=<xsl:value-of select="$document"/>&amp;n=<xsl:value-of select="@n"/>&amp;id=<xsl:value-of select="@base"/>&amp;corresp=<xsl:value-of select="ancestor::TEI.2//text[@id='AdsM1']//seg[@base=current()/@base]/@type"/></xsl:attribute><img src="images/navi/dot.jpg" border="0"/></a> <xsl:text> </xsl:text></xsl:if>
  <xsl:apply-templates/><br/><br/><br/><br/><br/>
 </xsl:when>
  <xsl:when test="@base='z011' and $document='AdsD2'">
  <xsl:if test="$text='doclinlay'"><a><xsl:attribute name="name"><xsl:value-of select="@n"/></xsl:attribute></a><a><xsl:attribute name="name"><xsl:value-of select="@base"/></xsl:attribute></a><a><xsl:if test="$export='print'"><xsl:attribute name="onclick">return false</xsl:attribute></xsl:if><xsl:attribute name="href">zin.htm?text=doclinlay&amp;document=<xsl:value-of select="$document"/>&amp;n=<xsl:value-of select="@n"/>&amp;id=<xsl:value-of select="@base"/>&amp;corresp=<xsl:value-of select="ancestor::TEI.2//text[@id='AdsM1']//seg[@base=current()/@base]/@type"/></xsl:attribute><img src="images/navi/dot.jpg" border="0"/></a> <xsl:text> </xsl:text></xsl:if><xsl:apply-templates/><br/><br/><br/><br/>
 </xsl:when>
 ...
 <xsl:when test="$text='doclinlay' and $document='AdsM1'">
  <a><xsl:attribute name="name"><xsl:value-of select="@n"/></xsl:attribute></a><a><xsl:attribute name="name"><xsl:value-of select="@base"/></xsl:attribute></a><a><xsl:if test="$export='print'"><xsl:attribute name="onclick">return false</xsl:attribute></xsl:if><xsl:attribute name="href">zin.htm?text=doclinlay&amp;document=<xsl:value-of select="$document"/>&amp;n=<xsl:value-of select="@n"/>&amp;id=<xsl:value-of select="@base"/>&amp;corresp=<xsl:value-of select="@type"/></xsl:attribute><img src="images/navi/dot.jpg" border="0"/></a> <xsl:text> </xsl:text><xsl:apply-templates/>
 </xsl:when>
 <xsl:when test="$text='doclinlay' and substring($document,1,3) = 'Ads' and $document!='AdsM1'">
  <a><xsl:attribute name="name"><xsl:value-of select="@n"/></xsl:attribute></a><a><xsl:attribute name="name"><xsl:value-of select="@base"/></xsl:attribute></a><a><xsl:if test="$export='print'"><xsl:attribute name="onclick">return false</xsl:attribute></xsl:if><xsl:attribute name="href">zin.htm?text=doclinlay&amp;document=<xsl:value-of select="$document"/>&amp;n=<xsl:value-of select="@n"/>&amp;id=<xsl:value-of select="@base"/>&amp;corresp=<xsl:value-of select="ancestor::TEI.2//text[@id='AdsM1']//seg[@base=current()/@base]/@type"/></xsl:attribute><img src="images/navi/dot.jpg" border="0"/></a> <xsl:text> </xsl:text><xsl:apply-templates/>
 </xsl:when>

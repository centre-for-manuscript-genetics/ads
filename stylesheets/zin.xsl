...
<div class="navigationright">
 <table align="center" width="100%">
  <tr>
     <!-- boven -->
   <td align="center" colspan="3"><p class="navigation"><a><xsl:attribute name="href"><!-- STATIC CONVERSION 2026-03-10: new url mapping --><xsl:value-of select="$document"/>-zinsvarianten.html#<xsl:value-of select="$n"/></xsl:attribute>Terug naar de tekst<br/><img border="0" src="images/navi/up.jpg"/></a></p></td></tr>
     <!-- links -->
    <tr><td align="right" width="49%"><p class="navigation"><xsl:if test="$segn = 'z001'"><img border="0" src="images/navi/left.jpg"/></xsl:if><xsl:if test="$segn != 'z001'"><a><xsl:attribute name="href"><!-- STATIC CONVERSION 2026-03-10: new url mapping -->zin-AdsM1-<xsl:if test="contains($document,'AdsM2')"><xsl:value-of select="//seg[@n = //seg[ancestor::text/@id='AdsM1' and substring($id,1,4)=@base]/@n - 1]/@n"/>-<xsl:value-of select="//seg[@n = substring(//seg[ancestor::text/@id='AdsM1' and substring($id,1,4)=@base]/@base,2,4) - 1]/@base"/>-<xsl:value-of select="//seg[@n = //seg[ancestor::text/@id='AdsM1' and substring($id,1,4)=@base]/@n - 1]/@type"/></xsl:if><xsl:if test="contains($document,'AdsM1')"><xsl:value-of select="//seg[@n=substring($n,1,3) - 1]/@n"/>-<xsl:value-of select="//seg[@n=substring($n,1,3) - 1]/@base"/>-<xsl:value-of select="//seg[@n=substring($n,1,3) - 1]/@type"/></xsl:if><xsl:if test="contains($document,'AdsD') or contains($document,'AdsP') or contains($document,'AdsT') or contains($document,'AdsM3')"><xsl:value-of select="//seg[@n = //seg[ancestor::text/@id='AdsM1' and substring($id,1,4)=@base]/@n - 1]/@n"/>-<xsl:value-of select="//seg[@n = substring(//seg[ancestor::text/@id='AdsM1' and substring($id,1,4)=@base]/@base,2,4) - 1]/@base"/>-<xsl:value-of select="//seg[@n = //seg[ancestor::text/@id='AdsM1' and substring($id,1,4)=@base]/@n - 1]/@type"/></xsl:if>.html</xsl:attribute>Vorige<xsl:text> </xsl:text><img border="0" src="images/navi/left.jpg"/></a></xsl:if></p></td>
     <!-- rechts -->
   <td width="1%"/><td align="left" width="49%"><p class="navigation"><xsl:if test="$segn = 'z324'"><img border="0" src="images/navi/right.jpg"/></xsl:if><xsl:if test="$segn != 'z324'"><a><xsl:attribute name="href"><!-- STATIC CONVERSION 2026-03-10: new url mapping -->zin-AdsM1-<xsl:if test="contains($document,'AdsM2')"><xsl:value-of select="//seg[@n = //seg[ancestor::text/@id='AdsM1' and substring($id,1,4)=@base]/@n + 1]/@n"/>-<xsl:value-of select="//seg[@n = substring(//seg[ancestor::text/@id='AdsM1' and substring($id,1,4)=@base]/@base,2,4) + 1]/@base"/>-<xsl:value-of select="//seg[@n = //seg[ancestor::text/@id='AdsM1' and substring($id,1,4)=@base]/@n + 1]/@type"/></xsl:if><xsl:if test="contains($document,'AdsM1')"><xsl:value-of select="//seg[@n=substring($n,1,3) + 1]/@n"/>-<xsl:value-of select="//seg[@n=substring($n,1,3) + 1]/@base"/>-<xsl:value-of select="//seg[@n=substring($n,1,3) + 1]/@type"/></xsl:if><xsl:if test="contains($document,'AdsD') or contains($document,'AdsP') or contains($document,'AdsT') or contains($document,'AdsM3')"><xsl:value-of select="//seg[@n = //seg[ancestor::text/@id='AdsM1' and substring($id,1,4)=@base]/@n + 1]/@n"/>-<xsl:value-of select="//seg[@n = substring(//seg[ancestor::text/@id='AdsM1' and substring($id,1,4)=@base]/@base,2,4) + 1]/@base"/>-<xsl:value-of select="//seg[@n = //seg[ancestor::text/@id='AdsM1' and substring($id,1,4)=@base]/@n + 1]/@type"/></xsl:if>.html</xsl:attribute><img border="0" src="images/navi/right.jpg"/><xsl:text> </xsl:text>Volgende</a></xsl:if></p></td></tr>
  </table>
 </div>
 </xsl:if>
...
<xsl:if test="ancestor::TEI.2//text[@id='AdsDD']//seg[@base=$correspseg]//app/rdg[contains(@wit,current()/@sigil)]">
  <p><b><a><xsl:attribute name="name"><xsl:value-of select="@n"/></xsl:attribute></a><a style="font-family:Arial Narrow;"><xsl:if test="$export='print'"><xsl:attribute name="onclick">return false</xsl:attribute></xsl:if><xsl:if test="$document=current()/@n"><xsl:attribute name="style">color:green;font-family:Arial Narrow;</xsl:attribute></xsl:if><xsl:attribute name="href"><!-- STATIC CONVERSION 2026-03-10: new url mapping --><xsl:value-of select="@n"/>-zinsvarianten.html#<xsl:value-of select="ancestor::TEI.2//seg[@base=$correspseg]/@base"/></xsl:attribute><xsl:value-of select="text()"/> [<xsl:value-of select="@n"/>]</a></b>:<br/>
...
<xsl:if test="ancestor::TEI.2//text[@id='AdsDD']//seg[@base=$correspsegDD]//app/rdg[contains(@wit,current()/@sigil)]">
  <p><b><a><xsl:attribute name="name"><xsl:value-of select="@n"/></xsl:attribute></a><a style="font-family:Arial Narrow;"><xsl:if test="$export='print'"><xsl:attribute name="onclick">return false</xsl:attribute></xsl:if><xsl:if test="$document=current()/@n"><xsl:attribute name="style">color:green;font-family:Arial Narrow;</xsl:attribute></xsl:if><!-- STATIC CONVERSION 2026-03-10: new url mapping --><xsl:attribute name="href"><xsl:value-of select="@n"/>-zinsvarianten.html#<xsl:value-of select="ancestor::TEI.2//seg[@base=$correspsegDD]/@base"/></xsl:attribute><xsl:value-of select="text()"/> [<xsl:value-of select="@n"/>]</a></b>:<br/>
...
<xsl:if test="substring(@n,6,1) = ''"><p><b><a><xsl:attribute name="name"><xsl:value-of select="@n"/></xsl:attribute></a><a style="font-family:Arial Narrow;"><xsl:if test="$export='print'"><xsl:attribute name="onclick">return false</xsl:attribute></xsl:if><xsl:if test="$document=current()/@n"><xsl:attribute name="style">color:green;font-family:Arial Narrow;</xsl:attribute></xsl:if><!-- STATIC CONVERSION 2026-03-10: new url mapping --><xsl:attribute name="href"><xsl:value-of select="@n"/>-zinsvarianten.html#<xsl:value-of select="ancestor::TEI.2//seg[@base=$correspseg]/@base"/></xsl:attribute><xsl:value-of select="text()"/> [<xsl:value-of select="@n"/>]</a></b>:<br/>
...
<xsl:if test="substring(@n,6,1) = 'a'"><p><b><a><xsl:attribute name="name"><xsl:value-of select="@n"/></xsl:attribute></a><a style="font-family:Arial Narrow;"><xsl:if test="$export='print'"><xsl:attribute name="onclick">return false</xsl:attribute></xsl:if><xsl:if test="$document=current()/@n"><xsl:attribute name="style">color:green;font-family:Arial Narrow;</xsl:attribute></xsl:if><!-- STATIC CONVERSION 2026-03-10: new url mapping --><xsl:attribute name="href"><xsl:value-of select="@n"/>-zinsvarianten.html#<xsl:value-of select="ancestor::TEI.2//seg[@base=$correspseg]/@base"/></xsl:attribute><xsl:value-of select="text()"/> [<xsl:value-of select="@n"/>]</a></b>:<br/><xsl:apply-templates select="ancestor::TEI.2//text[@id='AdsDD']//seg[@base=$correspseg]"><xsl:with-param name="wit" select="concat(substring(@n,1,5), 'a')"/></xsl:apply-templates></p></xsl:if>
...
<a><xsl:if test="$export='print'"><xsl:attribute name="onclick">return false</xsl:attribute></xsl:if><xsl:attribute name="href"><!-- STATIC CONVERSION 2026-03-10: new url mapping --><xsl:value-of select="substring($document,1,5)"/>-<xsl:if test="$document='AdsM1' and document('../../ads/xml/toc.xml')//toc/document[@id=substring($document,1,5)]/thumbs/page['061' &gt;= substring($n,1,3) and '055' &lt;= substring($n,1,3)]">3</xsl:if><xsl:if test="$document='AdsM1' and document('../../ads/xml/toc.xml')//toc/document[@id=substring($document,1,5)]/thumbs/page['130' &gt;= substring($n,1,3) and '120' &lt;= substring($n,1,3)]">6</xsl:if><xsl:if test="$document='AdsM1' and not(document('../../ads/xml/toc.xml')//toc/document[@id=substring($document,1,5)]/thumbs/page['061' &gt;= substring($n,1,3) and '055' &lt;= substring($n,1,3)]) and not(document('../../ads/xml/toc.xml')//toc/document[@id=substring($document,1,5)]/thumbs/page['130' &gt;= substring($n,1,3) and '120' &lt;= substring($n,1,3)])"><xsl:value-of select="document('../../ads/xml/toc.xml')//toc/document[@id=substring($document,1,5)]/thumbs/page[@segn &gt;= substring($n,1,3) and @segp &lt;= substring($n,1,3)]/@id"/></xsl:if><xsl:if test="$document!='AdsM1'"><xsl:value-of select="document('../../ads/xml/toc.xml')//toc/document[@id=substring($document,1,5)]/thumbs/page[@segn &gt;= substring($n,1,3) and @segp &lt;= substring($n,1,3)]/@id"/></xsl:if>-facsimile.html</xsl:attribute><img border="0" style="float:left;margin: 0px 10px 0px 0px;
border: 1px solid #666; padding: 2px;"><xsl:attribute name="src">images/<xsl:value-of select="substring($document,1,5)"/>/thumbs/<xsl:value-of select="substring($document,1,5)"/>-<xsl:if test="$document='AdsM1' and document('../../ads/xml/toc.xml')//toc/document[@id=substring($document,1,5)]/thumbs/page['061' &gt;= substring($n,1,3) and '055' &lt;= substring($n,1,3)]">3</xsl:if><xsl:if test="$document='AdsM1' and document('../../ads/xml/toc.xml')//toc/document[@id=substring($document,1,5)]/thumbs/page['130' &gt;= substring($n,1,3) and '120' &lt;= substring($n,1,3)]">6</xsl:if><xsl:if test="$document='AdsM1' and not(document('../../ads/xml/toc.xml')//toc/document[@id=substring($document,1,5)]/thumbs/page['061' &gt;= substring($n,1,3) and '055' &lt;= substring($n,1,3)]) and not(document('../../ads/xml/toc.xml')//toc/document[@id=substring($document,1,5)]/thumbs/page['130' &gt;= substring($n,1,3) and '120' &lt;= substring($n,1,3)])"><xsl:value-of select="document('../../ads/xml/toc.xml')//toc/document[@id=substring($document,1,5)]/thumbs/page[@segn &gt;= substring($n,1,3) and @segp &lt;= substring($n,1,3)]/@id"/></xsl:if><xsl:if test="$document!='AdsM1'"><xsl:value-of select="document('../../ads/xml/toc.xml')//toc/document[@id=substring($document,1,5)]/thumbs/page[@segn &gt;= substring($n,1,3) and @segp &lt;= substring($n,1,3)]/@id"/></xsl:if>.jpg</xsl:attribute></img></a>
 </td></tr><tr><td align="center"><font color="red"><a class="pb"><xsl:attribute name="name"><xsl:value-of select="@n"/></xsl:attribute>[<xsl:if test="$document='AdsM1' and document('../../ads/xml/toc.xml')//toc/document[@id=substring($document,1,5)]/thumbs/page['061' &gt;= substring($n,1,3) and '055' &lt;= substring($n,1,3)]">3</xsl:if><xsl:if test="$document='AdsM1' and document('../../ads/xml/toc.xml')//toc/document[@id=substring($document,1,5)]/thumbs/page['130' &gt;= substring($n,1,3) and '120' &lt;= substring($n,1,3)]">6</xsl:if><xsl:if test="$document='AdsM1' and not(document('../../ads/xml/toc.xml')//toc/document[@id=substring($document,1,5)]/thumbs/page['061' &gt;= substring($n,1,3) and '055' &lt;= substring($n,1,3)]) and not(document('../../ads/xml/toc.xml')//toc/document[@id=substring($document,1,5)]/thumbs/page['130' &gt;= substring($n,1,3) and '120' &lt;= substring($n,1,3)])"><xsl:value-of select="document('../../ads/xml/toc.xml')//toc/document[@id=substring($document,1,5)]/thumbs/page[@segn &gt;= substring($n,1,3) and @segp &lt;= substring($n,1,3)]/@id"/></xsl:if><xsl:if test="$document!='AdsM1'"><xsl:value-of select="document('../../ads/xml/toc.xml')//toc/document[@id=substring($document,1,5)]/thumbs/page[@segn &gt;= substring($n,1,3) and @segp &lt;= substring($n,1,3)]/@id"/></xsl:if>]</a><xsl:text> </xsl:text></font></td></tr></table></td></tr>
</table>
</div>
</xsl:template>

...
<!--<table class="main">-->
 ...
 <div class="inside">
 <xsl:if test="contains($text,'doclin') and $n=''"><table width="100%"><tr><td valign="top">[<xsl:if test="substring($document,1,5) != 'AdsM2' and substring($document,1,5) != 'AdsM3'"><xsl:value-of select="//front//witness[@n=$document]"/> (<a><xsl:attribute name="href"><xsl:value-of select="$overl"/><xsl:value-of select="substring(//front//witness[@n=$document]/@n,1,5)"/></xsl:attribute><xsl:value-of select="//front//witness[@n=$document]/@n"/></a>)</xsl:if><xsl:if test="substring($document,1,3)= 'Ads' and substring($document,4,2) = 'M2' or substring($document,5,2) = 'M2'">1934: Typoscript 'Achter de Schermen' (<!-- STATIC CONVERSION 2026-03-10: new url mapping --><a href="overlevering.html#AdsM2">AdsM2</a>)</xsl:if><xsl:if test="substring($document,1,5) = 'AdsM3'">1935: Correctie-exemplaar Groot Nederland met correcties (<a href="overlevering.html#AdsM3">AdsM3</a>)</xsl:if>]</td><!-- STATIC CONVERSION 2026-03-19: navigation cell only output for AdsM1 or doclincomp, to avoid empty bordered div in other witnesses --><xsl:if test="$export!='print' and ($document='AdsM1' or $text='doclincomp')"><td><div><xsl:attribute name="class"><xsl:if test="substring($document,1,3) = 'Ads'">navigationright2</xsl:if><xsl:if test="substring($document,1,3) = 'Opd' and $text='doclincomp'">navigationright2</xsl:if></xsl:attribute><xsl:if test="$text != 'doclinlay' and $text != 'doclincomp' and $document='AdsM1'"><p class="navigation"><img alt="dot" src="images/navi/dot.jpg"/><xsl:text> </xsl:text><a><!-- STATIC CONVERSION 2026-03-10: new url mapping --><xsl:attribute name="href"><xsl:value-of select="$document"/>-zinsvarianten.html</xsl:attribute>toon schrijfproces per zin</a></p></xsl:if><xsl:if test="$text = 'doclinlay' and $document='AdsM1' and $n=''"><p class="navigation"><img alt="dot" src="images/navi/dot.jpg"/><xsl:text> </xsl:text>Klik op '<img alt="dot" src="images/navi/dot.jpg"/>' voor de zinsvarianten</p></xsl:if><xsl:if test="$text='doclincomp'"><xsl:call-template name="doclincomp"/></xsl:if></div></td></xsl:if></tr></table></xsl:if>
 ...
 <div class="inside">
 <xsl:if test="contains($text,'doclin') and $n=''"><table width="100%"><tr><td valign="top">[<xsl:if test="substring($document,1,5) = 'AdsP1'">1956-57: Tsjip/De Leeuwentemmer, eerste drukproef voor het Verzameld Werk (<!-- STATIC CONVERSION 2026-03-10: new url mapping --><a href="overlevering.html#AdsP1">AdsP1</a>)</xsl:if><xsl:if test="substring($document,1,5) = 'OpdP1'">1956-57: Tsjip/De Leeuwentemmer, eerste drukproef voor het Verzameld Werk (<a href="overlevering.html#OpdP1">OpdP1</a>)</xsl:if>]</td><!-- STATIC CONVERSION 2026-03-19: navigation cell only output for AdsM1 or doclincomp, to avoid empty bordered div in other witnesses --><xsl:if test="$export!='print' and ($document='AdsM1' or $text='doclincomp')"><td><div><xsl:attribute name="class"><xsl:if test="substring($document,1,3) = 'Ads'">navigationright2</xsl:if><xsl:if test="substring($document,1,3) = 'Opd' and $text='doclincomp'">navigationright2</xsl:if></xsl:attribute><xsl:if test="$text != 'doclinlay' and $text != 'doclincomp' and substring($document,1,3) = 'Ads' and $document='AdsM1'"><p class="navigation"><img alt="dot" src="images/navi/dot.jpg"/><xsl:text> </xsl:text><a><!-- STATIC CONVERSION 2026-03-10: new url mapping --><xsl:attribute name="href"><xsl:value-of select="$document"/>-zinsvarianten.html</xsl:attribute>toon schrijfproces per zin</a></p></xsl:if><xsl:if test="$text = 'doclinlay' and substring($document,1,3) = 'Ads' and $n='' and $document='AdsM1'"><p class="navigation"><img alt="dot" src="images/navi/dot.jpg"/><xsl:text> </xsl:text>Klik op '<img alt="dot" src="images/navi/dot.jpg"/>' voor de zinsvarianten</p></xsl:if><xsl:if test="$text='doclincomp'"><xsl:call-template name="doclincomp"/></xsl:if></div></td></xsl:if></tr></table></xsl:if>
  <xsl:apply-templates select="descendant::text[@id=substring($document,1,5)]"/>
 </div>
 </xsl:if>
 <!-- M's met varianten -->
 ...
 <xsl:if test="$comp1!=''">[<xsl:if test="not(substring($comp1,4,1) = 'Z')"><xsl:value-of select="$comp1"/></xsl:if><xsl:if test="substring($comp1,4,1) = 'Z'"><xsl:value-of select="substring($comp1,1,3)"/><xsl:value-of select="substring($comp1,5,2)"/></xsl:if> vs. <xsl:if test="not(substring($comp2,4,1) = 'Z')"><xsl:value-of select="$comp2"/></xsl:if><xsl:if test="substring($comp2,4,1) = 'Z'"><xsl:value-of select="substring($comp2,1,3)"/><xsl:value-of select="substring($comp2,5,2)"/></xsl:if>]</xsl:if></td><!-- STATIC CONVERSION 2026-03-19: navigation cell only output for AdsM1 or doclincomp, to avoid empty bordered div in other witnesses --><xsl:if test="$export!='print' and ($document='AdsM1' or $text='doclincomp')"><td><div><xsl:attribute name="class"><xsl:if test="substring($document,1,3) = 'Ads'">navigationright2</xsl:if><xsl:if test="substring($document,1,3) = 'Opd' and $text='doclincomp'">navigationright2</xsl:if></xsl:attribute><xsl:if test="$text != 'doclinlay' and $text != 'doclincomp' and $document='AdsM1'"><p class="navigation"><img alt="dot" src="images/navi/dot.jpg"/><xsl:text> </xsl:text><a><!-- STATIC CONVERSION 2026-03-10: new url mapping --><xsl:attribute name="href">AdsM1-zinsvarianten.html</xsl:attribute>toon schrijfproces per zin</a></p></xsl:if><xsl:if test="$text = 'doclinlay' and $document='AdsM1' and $n=''"><p class="navigation"><img alt="dot" src="images/navi/dot.jpg"/><xsl:text> </xsl:text>Klik op '<img alt="dot" src="images/navi/dot.jpg"/>' voor de zinsvarianten</p></xsl:if>
 ...
 <xsl:if test="$comp1!=''">[<xsl:if test="not(substring($comp1,4,1) = 'Z')"><xsl:value-of select="$comp1"/></xsl:if><xsl:if test="substring($comp1,4,1) = 'Z'"><xsl:value-of select="substring($comp1,1,3)"/><xsl:value-of select="substring($comp1,5,2)"/></xsl:if> vs. <xsl:if test="not(substring($comp2,4,1) = 'Z')"><xsl:value-of select="$comp2"/></xsl:if><xsl:if test="substring($comp2,4,1) = 'Z'"><xsl:value-of select="substring($comp2,1,3)"/><xsl:value-of select="substring($comp2,5,2)"/></xsl:if>]</xsl:if></td><!-- STATIC CONVERSION 2026-03-19: navigation cell only output for AdsM1 or doclincomp, to avoid empty bordered div in other witnesses --><xsl:if test="$export!='print' and ($document='AdsM1' or $text='doclincomp')"><td><div><xsl:attribute name="class"><xsl:if test="substring($document,1,3) = 'Ads'">navigationright2</xsl:if><xsl:if test="substring($document,1,3) = 'Opd' and $text='doclincomp'">navigationright2</xsl:if></xsl:attribute><xsl:if test="$text != 'doclinlay' and $text != 'doclincomp' and substring($document,1,3) = 'Ads' and $document='AdsM1'"><p class="navigation"><img alt="dot" src="images/navi/dot.jpg"/><xsl:text> </xsl:text><a><!-- STATIC CONVERSION 2026-03-10: new url mapping --><xsl:attribute name="href"><xsl:value-of select="$document"/>-zinsvarianten.html</xsl:attribute>toon schrijfproces per zin</a></p></xsl:if><xsl:if test="$text = 'doclinlay' and substring($document,1,3) = 'Ads' and $n='' and $document='AdsM1'"><p class="navigation"><img alt="dot" src="images/navi/dot.jpg"/><xsl:text> </xsl:text>Klik op '<img alt="dot" src="images/navi/dot.jpg"/>' voor de zinsvarianten</p></xsl:if>
 <xsl:if test="$text='doclincomp'"><xsl:call-template name="doclincomp"/></xsl:if></div></td></xsl:if></tr></table></xsl:if>
  <xsl:apply-templates select="descendant::text[@id= concat(substring($document,1,3), 'DD')]"/>
 </div>
 </xsl:if>
 ...
 <div class="inside">
  ...
  <xsl:if test="$comp1!=''">[<xsl:if test="not(substring($comp1,4,1) = 'Z')"><xsl:value-of select="$comp1"/></xsl:if><xsl:if test="substring($comp1,4,1) = 'Z'"><xsl:value-of select="substring($comp1,1,3)"/><xsl:value-of select="substring($comp1,5,2)"/></xsl:if> vs. <xsl:if test="not(substring($comp2,4,1) = 'Z')"><xsl:value-of select="$comp2"/></xsl:if><xsl:if test="substring($comp2,4,1) = 'Z'"><xsl:value-of select="substring($comp2,1,3)"/><xsl:value-of select="substring($comp2,5,2)"/></xsl:if>]<br/></xsl:if></td><!-- STATIC CONVERSION 2026-03-19: navigation cell only output for AdsM1 or doclincomp, to avoid empty bordered div in other witnesses --><xsl:if test="$export!='print' and ($document='AdsM1' or $text='doclincomp')"><td><div><xsl:attribute name="class"><xsl:if test="substring($document,1,3) = 'Ads'">navigationright2</xsl:if><xsl:if test="substring($document,1,3) = 'Opd' and $text='doclincomp'">navigationright2</xsl:if></xsl:attribute><xsl:if test="$text != 'doclinlay' and $text != 'doclincomp' and substring($document,1,3) = 'Ads' and $document='AdsM1'"><p class="navigation"><img alt="dot" src="images/navi/dot.jpg"/><xsl:text> </xsl:text><a><xsl:attribute name="href">AdsM1-zinsvarianten.html</xsl:attribute>toon schrijfproces per zin</a></p></xsl:if><xsl:if test="$text = 'doclinlay' and substring($document,1,3) = 'Ads' and $n='' and $document='AdsM1'"><p class="navigation"><img alt="dot" src="images/navi/dot.jpg"/><xsl:text> </xsl:text>Klik op '<img alt="dot" src="images/navi/dot.jpg"/>' voor de zinsvarianten</p></xsl:if><xsl:if test="$text='doclincomp'"><xsl:call-template name="doclincomp"/></xsl:if></div></td></xsl:if></tr></table></xsl:if>
   <xsl:apply-templates select="descendant::text[@id= concat(substring($document,1,3), 'DD')]"/>
 </div>
 </xsl:if>
 <!-- de facs en zo -->

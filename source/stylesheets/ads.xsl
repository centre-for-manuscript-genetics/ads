...
<xsl:param name="documentn" select="document('../xml/toc.xml')//toc/document[@id=$document]/@n"/>
...
<xsl:choose>
 ...
 <table align="center" width="100%">
  <tr>
     <!-- boven -->
   <td align="center" colspan="3"><p class="navigation"><xsl:if test="$pagefirst"><img alt="up" src="images/navi/up.jpg"/></xsl:if><xsl:if test="not($pagefirst)"><a><xsl:attribute name="href"><!-- STATIC CONVERSION 2026-03-10: new url mapping --><xsl:value-of select="$document"/>-<xsl:value-of select="document('../xml/toc.xml')//toc/document[@id=$document]/thumbs/page[@n=$pageid - 1]/@id"/>-<xsl:if test="$text='docfacs'">facsimile</xsl:if><xsl:if test="$text='docfacstopo'">topo</xsl:if><xsl:if test="$text='docfacspop'">popup</xsl:if>.html</xsl:attribute><xsl:if test="not(contains(document('../xml/toc.xml')//toc/document[@id=$document]/thumbs/page[@n=$pageid - 1]/@id,'a'))">p. </xsl:if><xsl:value-of select="document('../xml/toc.xml')//toc/document[@id=$document]/thumbs/page[@n=$pageid - 1]/@id"/><br/><img alt="up" src="images/navi/up.jpg"/></a></xsl:if></p></td></tr>
     <!-- links -->
   <tr><td align="right" width="49%"><p class="navigation"><xsl:if test="$documentn = '1'"><img alt="left" src="images/navi/left.jpg"/></xsl:if><xsl:if test="$documentn != '1'"><a><xsl:attribute name="href"><!-- STATIC CONVERSION 2026-03-10: new url mapping --><xsl:value-of select="document('../xml/toc.xml')//toc/document[@n=$documentn - 1]/@id"/>-<xsl:value-of select="document('../xml/toc.xml')//toc/document[@id=$document]/thumbs/page[@id=$page]/@prev"/>-facsimile.html</xsl:attribute><xsl:value-of select="document('../xml/toc.xml')//toc/document[@n=$documentn - 1]/@short"/><xsl:text> </xsl:text><img alt="left" src="images/navi/left.jpg"/></a></xsl:if></p></td>
     <!-- rechts -->
   <td width="1%"/><td align="left" width="49%"><p class="navigation"><xsl:if test="$documentn = '24'"><img alt="right" src="images/navi/right.jpg"/></xsl:if><xsl:if test="$documentn != '24'"><a><xsl:attribute name="href"><!-- STATIC CONVERSION 2026-03-10: new url mapping --><xsl:value-of select="document('../xml/toc.xml')//toc/document[@n=$documentn + 1]/@id"/>-<xsl:value-of select="document('../xml/toc.xml')//toc/document[@id=$document]/thumbs/page[@id=$page]/@next"/>-facsimile.html</xsl:attribute><img alt="right" src="images/navi/right.jpg"/><xsl:text> </xsl:text><xsl:value-of select="document('../xml/toc.xml')//toc/document[@n=$documentn + 1]/@short"/></a></xsl:if></p></td></tr>
     <!-- onder -->
   <tr><td align="center" colspan="3"><p class="navigation"><xsl:if test="$pagelast"><img alt="down" src="images/navi/down.jpg"/></xsl:if><xsl:if test="not($pagelast)"><a><xsl:attribute name="href"><!-- STATIC CONVERSION 2026-03-10: new url mapping --><xsl:value-of select="$document"/>-<xsl:value-of select="document('../xml/toc.xml')//toc/document[@id=$document]/thumbs/page[@n=$pageid + 1]/@id"/>-<xsl:if test="$text='docfacs'">facsimile</xsl:if><xsl:if test="$text='docfacstopo'">topo</xsl:if><xsl:if test="$text='docfacspop'">popup</xsl:if>.html</xsl:attribute><img alt="down" src="images/navi/down.jpg"/><br/><xsl:if test="not(contains(document('../xml/toc.xml')//toc/document[@id=$document]/thumbs/page[@n=$pageid + 1]/@id,'a'))">p. </xsl:if><xsl:value-of select="document('../xml/toc.xml')//toc/document[@id=$document]/thumbs/page[@n=$pageid + 1]/@id"/></a></xsl:if></p></td></tr>
  </table>
 </div>
 </xsl:if>
 ...
 <h2><xsl:if test="$text='docfacs' or $text='docfacspop'">Facsimile</xsl:if><xsl:if test="$text='docfacstopo'">Topografische transcriptie</xsl:if> van<br/> <xsl:value-of select="$document"/>, <xsl:if test="not(contains(document('../xml/toc.xml')//toc/document[@id=$document]/thumbs/page[@n=$pageid]/@id,'a'))">pagina</xsl:if><xsl:text> </xsl:text><xsl:value-of select="$page"/></h2>
 <!-- image -->
 ...
 <!-- STATIC CONVERSION 2026-03-13: HTML review: removed <center> and added class to image -->
  ...
  <xsl:if test="$export!='print'">
    ...
    <table id="thumbs">
<xsl:for-each select="document('../xml/toc.xml')//toc/document[@id=$document]/thumbs">
<tr>
...
<!-- original, with new url mapping 
 ...
 <table align="center" width="100%">
  <tr>
     <!-- boven -->
   <td align="center" colspan="3"><p class="navigation"><xsl:if test="$pagefirst"><img alt="up" src="images/navi/up.jpg"/></xsl:if><xsl:if test="not($pagefirst)"><a><xsl:attribute name="href"><xsl:value-of select="substring($document,1,3)"/>.htm?text=<xsl:if test="$text='docfacspop'">docfacs</xsl:if><xsl:if test="$text!='docfacspop'"><xsl:value-of select="$text"/></xsl:if>&amp;document=<xsl:value-of select="$document"/>&amp;page=<xsl:value-of select="document('../xml/toc.xml')//toc/document[@id=$document]/thumbs/page[@n=$pageid - 1]/@id"/></xsl:attribute>p. <xsl:value-of select="document('../xml/toc.xml')//toc/document[@id=$document]/thumbs/page[@n=$pageid - 1]/@id"/><br/><img alt="up" src="images/navi/up.jpg"/></a></xsl:if></p></td></tr>
     <!-- links -->
   <tr><td align="right" width="49%"><p class="navigation"><xsl:if test="$documentn = '1'"><img alt="left" src="images/navi/left.jpg"/></xsl:if><xsl:if test="$documentn != '1'"><a><xsl:attribute name="href"><xsl:if test="starts-with(document('../xml/toc.xml')//toc/document[@n=$documentn - 1]/@id,'Ads')">Ads.htm</xsl:if><xsl:if test="starts-with(document('../xml/toc.xml')//toc/document[@n=$documentn - 1]/@id,'Opd')">Opd.htm</xsl:if>?text=docfacs&amp;document=<xsl:value-of select="document('../xml/toc.xml')//toc/document[@n=$documentn - 1]/@id"/>&amp;page=<xsl:value-of select="document('../xml/toc.xml')//toc/document[@id=$document]/thumbs/page[@id=$page]/@prev"/></xsl:attribute><xsl:value-of select="document('../xml/toc.xml')//toc/document[@n=$documentn - 1]/@short"/><xsl:text> </xsl:text><img alt="left" src="images/navi/left.jpg"/></a></xsl:if></p></td>
     <!-- rechts -->
   <td width="1%"/><td align="left" width="49%"><p class="navigation"><xsl:if test="$documentn = '24'"><img alt="right" src="images/navi/right.jpg"/></xsl:if><xsl:if test="$documentn != '24'"><a><xsl:attribute name="href"><xsl:if test="starts-with(document('../xml/toc.xml')//toc/document[@n=$documentn + 1]/@id,'Ads')">Ads.htm</xsl:if><xsl:if test="starts-with(document('../xml/toc.xml')//toc/document[@n=$documentn + 1]/@id,'Opd')">Opd.htm</xsl:if>?text=docfacs&amp;document=<xsl:value-of select="document('../xml/toc.xml')//toc/document[@n=$documentn + 1]/@id"/>&amp;page=<xsl:value-of select="document('../xml/toc.xml')//toc/document[@id=$document]/thumbs/page[@id=$page]/@next"/></xsl:attribute><img alt="right" src="images/navi/right.jpg"/><xsl:text> </xsl:text><xsl:value-of select="document('../xml/toc.xml')//toc/document[@n=$documentn + 1]/@short"/></a></xsl:if></p></td></tr>
     <!-- onder -->
   <tr><td align="center" colspan="3"><p class="navigation"><xsl:if test="$pagelast"><img alt="down" src="images/navi/down.jpg"/></xsl:if><xsl:if test="not($pagelast)"><a><xsl:attribute name="href"><xsl:value-of select="substring($document,1,3)"/>.htm?text=<xsl:if test="$text='docfacspop'">docfacs</xsl:if><xsl:if test="$text!='docfacspop'"><xsl:value-of select="$text"/></xsl:if>&amp;document=<xsl:value-of select="$document"/>&amp;page=<xsl:value-of select="document('../xml/toc.xml')//toc/document[@id=$document]/thumbs/page[@n=$pageid + 1]/@id"/></xsl:attribute><img alt="down" src="images/navi/down.jpg"/><br/>p. <xsl:value-of select="document('../xml/toc.xml')//toc/document[@id=$document]/thumbs/page[@n=$pageid + 1]/@id"/></a></xsl:if></p></td></tr>
  </table>
 </div>
 </xsl:if>

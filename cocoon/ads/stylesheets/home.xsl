...
<p class="inleiding">Zie voor de verschillende mogelijkheden de <a href="gebruiksaanwijzing.htm?text=gebruiksaanwijzing&amp;document=gebruiksaanwijzing">Gebruiksaanwijzing</a>. Onder Home zijn een <a href="inleiding.htm?text=inleiding&amp;document=inleiding">inleiding</a> bij beide teksten en een beschrijvend <a href="overlevering.htm?text=overlevering&amp;document=overlevering">overzicht</a> van de opgenomen bronnen te vinden.</p>
...
<div><center><img src="colofon.jpg" usemap="#colofon_Map" border="0"/></center></div>

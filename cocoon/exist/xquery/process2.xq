...
{
    if (empty($hits)) then
        <p>Nothing found! <a href="try.html">Back to search form</a>.</p>
    else
        ...
        return (
            <table class="display" border="0" width="100%"
                ...
                { f:navbar($start, $end, $howmany, $count) }
                {
                    ...
                    return
                        <tr class="{$style}">
                            <td valign="top" align="left" class="position">{$p}</td>
                            <td colspan="2">
    ...
    return
        if ($query) then
           f:eval($query)
            ...
            <p>Please specify a query! <a href="try.html">Back to search
            form</a>.</p>
};
...
<document xmlns:xi="http://www.w3.org/2001/XInclude">
    ...
    <header>
        <title>Stirrings Still / Soubresauts</title>
	    <author email="wolfgang@exist-db.org">Wolfgang M. Meier</author>
        <style href="styles/newbeckett.css"/>
    </header>    
